...
<div class="templatemo-content col-1 light-gray-bg">
	<div class="templatemo-content-container">
		<h3 style="font-size: 35px; margin: 20px 0 30px;">QUẢN LÝ SUẤT
			CHIẾU</h3>
		<div class="row ml-1"
			...
			<div class="col-lg-3 col-md-6">
				<a class="btn  "
					href="${pageContext.request.contextPath}/admin/addSuatChieu">Thêm
					suất chiếu mới</a>
			</div>
		</div>
				...
				<table
					...
					<thead>
						<tr>
							...
							<td><a href="" class="white-text templatemo-sort-by">Mã
									suất chiếu <span class="caret"></span>
							</a></td>
							<td><a href="" class="white-text templatemo-sort-by">Tên
									phim <span class="caret"></span>
							</a></td>
							<td><a href="" class="white-text templatemo-sort-by">Têp
							...
							<td><a href="" class="white-text templatemo-sort-by">Giờ
									chiếu <span class="caret"></span>
							</a></td>
							<td><a href="" class="white-text templatemo-sort-by">Số
									ghế đặt <span class="caret"></span>
							</a></td>
							<td><a href="" class="white-text templatemo-sort-by">Số
									ghế trống <span class="caret"></span>
							</a></td>
							<td>Sửa</td>
							<td>Xóa</td>
						</tr>
